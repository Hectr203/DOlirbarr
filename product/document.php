 ...
 * Actions
 */
if ($action == 'upload_image' && $permissiontoadd) {
    // Verifica si se ha subido una imagen
    if (!empty($_FILES['product_image']['name'])) {
        $image_path = $_FILES['product_image']['tmp_name'];
...
print '<input type="file" name="product_image">';
print '<input type="submit" class="button button-save" value="'.$langs->trans('guardar producto').'">';
print '</form>';
